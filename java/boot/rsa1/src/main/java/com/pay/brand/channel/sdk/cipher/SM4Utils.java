...
public class SM4Utils {
    ...
    private static byte[] encryptCbcPadding(byte[] key, byte[] data, String algorithmName) {
        try {
            ...
            throw new CipherException("sm4 encrypt cbc error", e);
        }
    }
    ...
    private static byte[] decryptCbcPadding(byte[] key, byte[] encryptData, String algorithmName) {
        try {
            ...
            throw new CipherException("sm4 decrypt cbc error", e);
        }
    }
    ...
    private static Cipher generateCbcCipher(String algorithmName, int mode, byte[] key, byte[] iv) {
        try {
            ...
            throw new CipherException("sm4 generate cbc cipher error", e);
        }
    }
